...
#define DIY_PRUSA_MINI_VERSION 20240127
...
#define STRING_CONFIG_H_AUTHOR "(thisiskeithb, DIY Prusa Mini)" // Who made the changes.
 ...
 */
  ...
  #define MPC_HEATER_POWER DIY_PRUSA_MINI_CUSTOM_MPC_HEATER_POWER // (W) Heat cartridge powers.
