...
#define DIY_PRUSA_MINI_VERSION 20250927
...
#define STRING_CONFIG_H_AUTHOR "(thisiskeithb, DIY Prusa Mini)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME DIY_PRUSA_MINI_CUSTOM_PRINTER_NAME
 ...
 */
#define TEMP_SENSOR_0 DIY_PRUSA_MINI_TEMP_SENSOR_0
...
#define HEATER_0_MAXTEMP 305 // 290 + 15
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    // Prusa Mini
    #define DEFAULT_Kp DIY_PRUSA_MINI_DEFAULT_Kp
    #define DEFAULT_Ki DIY_PRUSA_MINI_DEFAULT_Ki
    #define DEFAULT_Kd DIY_PRUSA_MINI_DEFAULT_Kd
 ...
 */
  ...
  #define MPC_HEATER_POWER { DIY_PRUSA_MINI_CUSTOM_MPC_HEATER_POWER } // (W) Nominal heat cartridge powers.
  ...
  #define MPC_BLOCK_HEAT_CAPACITY DIY_PRUSA_MINI_CUSTOM_MPC_BLOCK_HEAT_CAPACITY  // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS DIY_PRUSA_MINI_CUSTOM_MPC_SENSOR_RESPONSIVENESS  // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF DIY_PRUSA_MINI_CUSTOM_MPC_AMBIENT_XFER_COEFF  // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 DIY_PRUSA_MINI_CUSTOM_MPC_AMBIENT_XFER_COEFF_FAN255  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
  ...
  #define FILAMENT_HEAT_CAPACITY_PERMM DIY_PRUSA_MINI_CUSTOM_FILAMENT_HEAT_CAPACITY_PERMM // 0.0056 J/K/mm for 1.75mm PLA (0.0149 J/K/mm for 2.85mm PLA).
...
#define PIDTEMPBED
  ...
  // Prusa Mini
  #define DEFAULT_bedKp DIY_PRUSA_MINI_DEFAULT_bedKp
  #define DEFAULT_bedKi DIY_PRUSA_MINI_DEFAULT_bedKi
  #define DEFAULT_bedKd DIY_PRUSA_MINI_DEFAULT_bedKd
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT DIY_PRUSA_MINI_DEFAULT_AXIS_STEPS_PER_UNIT
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET DIY_PRUSA_MINI_NOZZLE_TO_PROBE_OFFSET
...
#define INVERT_X_DIR DIY_PRUSA_MINI_INVERT_X_DIR
#define INVERT_Y_DIR DIY_PRUSA_MINI_INVERT_Y_DIR
#define INVERT_Z_DIR DIY_PRUSA_MINI_INVERT_Z_DIR
...
#define INVERT_E0_DIR DIY_PRUSA_MINI_INVERT_E0_DIR
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 147.4     // (mm) X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT 21.1      // (mm) Y point for Z homing
  //#define Z_SAFE_HOMING_POINT_ABSOLUTE  // Ignore home offsets (M206) for Z homing position
#endif

// Homing speeds (linear=mm/min, rotational=°/min)
#define HOMING_FEEDRATE_MM_M DIY_PRUSA_MINI_HOMING_FEEDRATE_MM_M
...
#define PREHEAT_9_LABEL       "FLEX"
#define PREHEAT_9_TEMP_HOTEND 240
#define PREHEAT_9_TEMP_BED     50
